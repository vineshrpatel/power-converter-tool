...
def ltspice_halfbridge_simulation(f, D, Vin, Lc, Lcoupling, C, R):

    AbsPath = os.path.dirname(os.path.realpath(__file__)) 
    # LTC = SimCommander(AbsPath + "\\boost_circuit.asc")

    # Full path to circuit file
    circuit_file = os.path.join(AbsPath, "ltspice_circuits", "halfbridge_circuit.asc")
    raw_file = os.path.join(AbsPath, "ltspice_circuits", "halfbridge_circuit_1.raw")
...
# ltspice_halfbridge_simulation(12e3, 0.109, 55, 81.439e-6, 904.882e-6, 20.833e-6, 10)