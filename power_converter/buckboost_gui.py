...
from power_converter.buckboost_calcs import solve_buckboost_converter
from power_converter.unit_prefixes import format_value
from power_converter.buckboost_circuit import display_buckboost
from power_converter.buckboost_simulation import ltspice_buckboost_simulation
from matplotlib.backends.backend_tkagg import FigureCanvasTkAgg, NavigationToolbar2Tk
import matplotlib.pyplot as plt

def run_buckboost_gui():
    ...
    def calculate():
        ...
        try:
            ...
            results = solve_buckboost_converter(Vin, Vout, f, R_load, rippleV, L)

            # Store calculated results
            results_data["Calculations"] = {
                "D": f"{results['D']}",
                "I_load": f"{results['I_load']}A",
                "L_primary": f"{results['Lc']}H",
                "C": f"{results['C_min']}F",
            ...
            display_buckboost(Vin, L, results["C_min"], R_load, results["I_load"], circuit_canvas)
            ...
            fig = ltspice_buckboost_simulation(f,
    ...
    root = ctk.CTk()
    root.title("Buck-Boost Converter Design")
    ...
    maxIsw_changed_label.grid(row=4, column=2, sticky='w', padx=(40,0))
