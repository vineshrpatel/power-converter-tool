...
from power_converter.fullbridge_calcs import solve_fullbridge_converter
from power_converter.unit_prefixes import format_value
from power_converter.fullbridge_circuit import display_fullbridge
from power_converter.fullbridge_simulation import ltspice_fullbridge_simulation
from matplotlib.backends.backend_tkagg import FigureCanvasTkAgg, NavigationToolbar2Tk
import matplotlib.pyplot as plt

def run_fullbridge_gui():
    ...
    def calculate():
        ...
        try:
            ...
            results = solve_fullbridge_converter(Vin, Vout, f, n, R_load, rippleV, L)
            ...
            display_fullbridge(Vin, L, Ls, results["C"], R_load, results["I_load"], circuit_canvas)
            ...
            fig = ltspice_fullbridge_simulation(f,
    ...
    root = ctk.CTk()
    root.title("Full Bridge Converter Calculator")
