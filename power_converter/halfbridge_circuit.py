...
def display_halfbridge_equations(img, font_size):
    """
    ...
    equations = [
        r"Equations used:",
        r"$D = \frac{V_{\text{out}\cdot n} \cdot n}{V_{\text{in}}}$",
...
def display_halfbridge(Vin, Lc, Lcoupling, C, R_load, I_load, canvas):
    # Display circuit
    with pkg_resources.path(circuit_diagrams, 'halfbridge_circuit.png') as img_path:
    ...
    eq_img = display_halfbridge_equations(eq_img, 10)
