...
from power_converter.forward_calcs import solve_forward_converter
from power_converter.unit_prefixes import format_value
from power_converter.forward_circuit import display_forward
from power_converter.forward_simulation import ltspice_forward_simulation
...
def run_forward_gui():
    ...
    def calculate():
        ...
        try:
            ...
            results = solve_forward_converter(Vin, Vout, f, n, R_load, rippleV, L)
            ...
            if L is not None:
                ...
                deltaIL_changed_val.configure(text=f"{results['IL_ripple_changed']}A")
                ...
                results_data["Additional Calculations"] = {
                    ...
                    "IL_ripple_(for custom L)": f"{results['IL_ripple_changed']}A",
            ...
            display_forward(Vin, L, Ls, results["C"], R_load, results["I_load"], circuit_canvas)
            ...
            fig = ltspice_forward_simulation(f,
    ...
    root = ctk.CTk()
    root.title("Forward Converter Calculator")
