...
def ltspice_buckboost_simulation(f, D, Vin, L, C, R):

    AbsPath = os.path.dirname(os.path.realpath(__file__)) 
    # LTC = SimCommander(AbsPath + "\\boost_circuit.asc")

    # Full path to circuit file
    circuit_file = os.path.join(AbsPath, "ltspice_circuits", "buckboost_circuit.asc")
    raw_file = os.path.join(AbsPath, "ltspice_circuits", "buckboost_circuit_1.raw")
    ...
    # fig.suptitle('Boost Converter Simulation Results')
...
# ltspice_boost_simulation(80e3, 0.37, 26, 10e-3, 89e-6, 10)