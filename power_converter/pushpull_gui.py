...
from power_converter.pushpull_calcs import solve_pushpull_converter
from power_converter.unit_prefixes import format_value
from power_converter.pushpull_circuit import display_pushpull
from power_converter.pushpull_simulation import ltspice_pushpull_simulation
from matplotlib.backends.backend_tkagg import FigureCanvasTkAgg, NavigationToolbar2Tk
import matplotlib.pyplot as plt

def run_pushpull_gui():
    ...
    def calculate():
        ...
        try:
            ...
            results = solve_pushpull_converter(Vin, Vout, f, n, R_load, rippleV, L)
            ...
            display_pushpull(Vin, L, Ls, results["C"], R_load, results["I_load"], circuit_canvas)
            ...
            fig = ltspice_pushpull_simulation(f,
    ...
    root = ctk.CTk()
    root.title("Pushpull Converter Calculator")
